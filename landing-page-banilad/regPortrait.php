...
<!-- END OF THE DIVISION -->
            ...
            <div class="nav-side-b">
                ...
                <div class="tagging-container">
                    ...
                    <?php require_once 'taggings/index-regular-portrait-tag.php'?> <!-- THIS IS THE REGULAR PORTRAINT TEMPLATE -->
                ...
                <?php
                    $stmt = $conn->prepare("SELECT * FROM `reg_Tag_prt`");  
                    $stmt->execute();
                    ...
                    if($page_user > 1){
                        echo "<a class='pageStyle' href='regPortrait.php?page_user=".($page_user - 1)."'>Prev</a>";
                        }

                        for($i = 1; $i < $total_page_user; $i++){
                                echo "<a class='pageStyle' href='regPortrait.php?page_user=".$i."'>$i</a>";
                        }

                        if($i > $page_user){
                            echo "<a class='pageStyle' href='regPortrait.php?page_user=".($page_user + 1)."'>Next</a>";
                        }
                ?>
