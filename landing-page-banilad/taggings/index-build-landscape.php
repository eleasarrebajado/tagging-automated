...
$start_from = ($page_user-1)*07;
    ...
    $stmt = $conn->prepare("SELECT * FROM `build_lndscape` ORDER BY build_id_lndscape DESC limit $start_from, $num_per_page");
    $stmt->execute();
        ...
        <div class="tag-wrapper" id="ball">
            <div class="tag-wrapper__container">
                ...
                <div class="footer-container-lnd">
                    <ul>
                        <li><b><?php echo $row['build_prdct_name']; ?></b></li>
                        <li><?php echo $row['build_descript']; ?></li>
                        <li style="font-weight: bold; font-size: 0.7rem;"><span>An:</span><?php echo $row['build_article']; ?></li>
                    </ul>
                </div>
            </div>
            <a href="buildLandscape.php?build_delete_lndscape=<?php echo $row['build_id_lndscape']; ?>">delete</a>
        </div>
    </div>
