                    ...
                    <li>
                        ...
                        <div class="list-btn__list-container">
                            <form id="listDrop-c" method="post" action="process_tag/process.php" enctype="multipart/form-data">
                                ...
                                <div class="tagg-links">
                                    <ul>
                                        <li><a href="rocaPrt.php">Go Back to Portrait</a></li>
                                    </ul>
                                </div>
                                <p>Landscape</p>
...
<!-- END OF THE DIVISION -->
                    <li>
                        ...
                        <div class="list-btn__list-container">
                            <form id="listDrop-d" method="post" action="">
                                <p>portrait</p>
...
<!-- END OF THE DIVISION -->
            ...
            <div class="nav-side-b">
                ...
                <div class="tagging-container">
                    ...
                    <?php require_once 'taggings/index-roca-prt.php'?> <!-- THIS IS THE REGULAR PORTRAINT TEMPLATE -->
                ...
                <?php
                    $stmt = $conn->prepare("SELECT * FROM `roca_prt`");  
                    $stmt->execute();
                    ...
                    if($page_user > 1){
                        echo "<a class='pageStyle' href='rocaPrt.php?page_user=".($page_user - 1)."'>Prev</a>";
                        }

                        for($i = 1; $i < $total_page_user; $i++){
                                echo "<a class='pageStyle' href='rocaPrt.php?page_user=".$i."'>$i</a>";
                        }

                        if($i > $page_user){
                            echo "<a class='pageStyle' href='rocaPrt.php?page_user=".($page_user + 1)."'>Next</a>";
                        }
                ?>
