...
<!-- END OF THE DIVISION -->
            ...
            <div class="nav-side-b">
                ...
                <?php
                    $stmt = $conn->prepare("SELECT * FROM `reg_Tag`");  
                    $stmt->execute();
                    ...
                    if($page_user > 1){
                        echo "<a class='pageStyle' href='regLandscape.php?page_user=".($page_user - 1)."'>Prev</a>";
                        }

                        for($i = 1; $i < $total_page_user; $i++){
                                echo "<a class='pageStyle' href='regLandscape.php?page_user=".$i."'>$i</a>";
                        }

                        if($i > $page_user){
                            echo "<a class='pageStyle' href='regLandscape.php?page_user=".($page_user + 1)."'>Next</a>";
                        }
                ?>
