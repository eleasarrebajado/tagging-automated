                    ...
                    <li>
                        ...
                        <div class="list-btn__list-container">
                            <form id="listDrop-c" method="post" action="process_tag/process.php" enctype="multipart/form-data">
                                ...
                                <input type="submit" name="deleteAllRoca" value="Delete All">
                                <p>Landscape</p>
                    ...
                    <li>
                        ...
                        <div class="list-btn__list-container">
                            <form id="listDrop-d" method="post" action="process_tag/process.php" enctype="multipart/form-data">
                                ...
                                <input type="submit" name="deleteBuild" value="Delete All">
                            </form>
                        </div>
                    </li>
<!-- END OF THE DIVISION -->
            ...
            <div class="nav-side-b">
                ...
                <div class="tagging-container">
                    <div class="tagging-print-size">
                        <!-- <?php require_once 'taggings/index-regular-tagging.php'?> THIS IS THE REGULAR TAGGING LANDSCAPE -->
                        <!-- <?php require_once 'taggings/index-regular-portrait-tag.php'?> THIS IS THE REGULAR PORTRAIT TAGGING -->

                        <!-- <?php require_once 'taggings/index-cool-landscape.php'?>THIS IS THE COOL LANDSCAPE TAGGING -->
                        <!-- <?php require_once 'taggings/index-cool-portrait-tag.php' ?>THIS IS THE REGULAR PORTRAIT TAGGING -->
                    </div> 
                </div>
                <div class="page-container">


<!-- THIS IS THE REGULAR PORTRAIT TAGGING DIVISION START -->
<!-- THIS IS THE REGULAR PORTRAIT TAGGING DIVISION START -->
